function fig = plotThetaCurrentData(file,fieldName,dataType)
...
%     yscaleBar = 20; % mV
    ...
    switch dataType
        ...
        case 'theta'
            trial_data = file.(fieldName).theta_data(:,trial); 
    end
    ...
    switch fieldName
        case 'cell'
            [color,alpha] = getCellcolor(file.info.cell_type,file.info.dataSet,file.info.comments);
        case 'lfp'
            color = [0 0 0]; % black
            alpha = 1; % opaque
    end
